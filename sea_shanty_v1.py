...
if len(article_text) > 5:
    ...
    if st.button ('Strike me a shanty, me hearties!'):
        response = openai.Completion.create(
            ...
            prompt = "You are an 'Arrr-tifcial Intelligence Model' that interprets text input and converts into a funny and relevant sea shanty. Use only the text information located here: " + article_text,
            max_tokens = 3000,
